...
<html lang="de">
  <head>
    ...
    <title>Audiboox</title>

    <!-- Bootstrap core CSS -->
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="css/bootstrap-theme.min.css"> 
<link rel="icon" type="image/png" href="symbol5.png">
  ...
  <nav class="navbar navbar-inverse navbar-static-top">
      <div class="container">
         ...
         <ul class="nav navbar-nav navbar-right">     
          ...
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
            ...
            <span class="icon-bar"></span>
                  ...
                  <a class="navbar-brand" href="index.php"><i> <img width= 50 height=50;  src='symbol5.png' /></i> Audioboox</a>
        ...
        <div id="navbar" class="navbar-collapse collapse">
         ...
         <ul class="nav navbar-nav navbar-right">     
         	<li><a href="file-upload.php">Converter</a></li>       
			<li><a href="libary.php">Archiv</a></li> 
