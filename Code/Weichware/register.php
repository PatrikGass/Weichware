...
<div class="form-group">
<label for="inputAbo">Abomodell</label><br />
  <select name="inputAbo" id="inputAbo" 	class="form-control">
    <option value="test">Testphase</option>
    <option value="free" disabled="disabled">Free</option>
    <option value="basic" disabled="disabled">Basic</option>
    <option value="pro" disabled="disabled">Pro</option>
	<option value="premium" disabled="disabled">Premium</option>
